package com.cleancode.chapter14.step6_create_doubleargs_marshaler;
...
public class Args {
	...
	enum ErrorCode {
		OK, MISSING_BOOLEAN, MISSING_STRING, MISSING_INTEGER, INVALID_INTEGER, UNEXPECTED_ARGUMENT
	}
